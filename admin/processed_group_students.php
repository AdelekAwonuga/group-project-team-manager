                        ...
                        <div class="panel-body">
                            <div class="table-responsive table-bordered">
                                <table class="table" id="example" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tbody>
<?php
$sql=mysqli_query($conn,"select * from processed_group_student inner join groups on processed_group_student.group_id=groups.group_id inner join student on processed_group_student.student_id=student.student_id order by p_id");
$cnt=1;
