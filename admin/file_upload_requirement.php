      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="active"><a href="file_upload_requirement.php">File Upload Requirement</a></li>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive table-bordered">
                                <table class="table" id="example" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tbody>
<?php
$sql=mysqli_query($conn,"select * from group_file_requirement inner join groups on group_file_requirement.group_id=groups.group_id");
$cnt=1;
