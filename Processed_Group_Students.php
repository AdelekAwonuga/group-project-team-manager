  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="Processed_Group_Students.php">Processed Group Students</a></li>
...
<p class="text-center text-uppercase"><strong>All My Group Members</strong></p>
 <!--    Bordered Table  -->
...
$sql=mysqli_query($conn,"select * from processed_group_student inner join student on processed_group_student.student_id=student.student_id inner join groups on processed_group_student.group_id=groups.group_id where processed_group_student.group_id='$group' order by p_id");
$cnt=1;
