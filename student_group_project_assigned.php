    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <li class="active"><a href="student_group_project_assigned.php">Student Group Project Assigned</a></li>
          </ul>
        </li>
		<!--view drop down end-->
...
<p class="text-center text-uppercase"><strong>All Files Requirement By Admin</strong></p>
 <!--    Bordered Table  -->
...
$sql=mysqli_query($conn,"select * from group_file_requirement where group_id='$group' order by r_id desc");
$cnt=1;
